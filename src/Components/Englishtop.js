...
export class Englishtop extends Component {
  constructor(props) {
    super(props);
    this.state = {
      res: "",
  ...
  componentDidMount() {
    axios
      .request(options)
      .then((res) => {
        console.log("Top English:", res.data);
        this.setState({
          res: res.data,
        });
    ...
    return (
      <div>
        ...
        <div style={{ textAlign: "center" }}>
          <Title level={2}>Top English songs 2020</Title>
        </div>
