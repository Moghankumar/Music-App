...
const options = {
  method: "GET",
  url: "https://deezerdevs-deezer.p.rapidapi.com/album/191488972",
  headers: {
...
export class Explorealbum extends Component {
  constructor(props) {
    super(props);
    this.state = {
      res: "",
  ...
  componentDidMount() {
    axios
      .request(options)
      .then((res) => {
        console.log("Explore Album:", res.data);
        this.setState({
          res: res.data,
        });
